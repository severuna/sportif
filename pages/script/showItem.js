...
export const showItem = (element) => {
    ...
    listItem.append(showImg(element.src), showTitle(element, element.title), showRating(element.rating), showPrice(element.price), showColors(element.colors), showAddBag());
    return listItem
}
